  ...
  return (
    <style>{`
      ...
      *,*::before,*::after{ box-sizing:border-box; }
      ...
      /* Fix finish cards: show full door image (no zoom) */
      .finish-img{
        border-radius:16px;
        overflow:hidden;
        border:1px solid var(--border);
          ...
          <>
            <div className="card soft">
              ...
              <div className="row" style={{ marginTop: 12 }}>
                ...
                <label
                  htmlFor="freight-ok"
                  style={{ margin: 0, textTransform: "none", letterSpacing: 0, fontSize: 13, color: "var(--muted)" }}
                >
...
function DesignCenter({ savedMeasurementSummary, onSaveMeasurementSummary }) {
  ...
  // Measurements (now includes Wall C + Wall D)
        ...
        <div className="grid two" style={{ marginTop: 16 }}>
          ...
          <div className="card soft">
            ...
            <p className="mini" style={{ marginTop: 8 }}>
              Wall lengths, ceiling height, windows/doors, appliance sizes, and a few photos from each corner.
            </p>

            <div className="divider" />
            <div className="kicker">Expectations</div>
            <p className="mini" style={{ marginTop: 8 }}>
              Typical lead time is 2–5 weeks (varies by finish and order size). Freight is confirmed after order.
            </p>
